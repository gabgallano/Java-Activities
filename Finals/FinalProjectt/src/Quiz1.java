...
public class Quiz1{
	...
	public Quiz1() {
        ...
        JLabel Speak = new JLabel("You can do it!"); // for the message bubble content
    	...
    	JRadioButton r3=new JRadioButton("F");
      ...
      btn.addActionListener(new ActionListener() { // an action listener to when this choice is selected
          public void actionPerformed(ActionEvent e) {
        	  ...
        	  Quiz2 p2=new Quiz2(); // directory of where it would go after clicking the button "nexT"
        	  }});
      ...
      myLabel.add(btn);
        ...
        ImageIcon QuesImg = new ImageIcon("images/Flower1.png"); // for the question images
