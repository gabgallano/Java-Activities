...
public class Quiz4{
	...
	public Quiz4() {
        ...
        JLabel Speak = new JLabel("Getting there, 4th!"); // for the message bubble content
        Speak.setBounds (85,340, 150,50);
        Speak.setFont(new Font("Comic Sans MS", Font.BOLD, 15));
        myLabel.add(Speak);
        
        JLabel Question = new JLabel("The Uppercase of this Letter is ___"); //for the question texts
        Question.setFont(new Font("Comic Sans MS", Font.BOLD, 15));
        Question.setBounds(80, 50, 290,120);
        myLabel.add(Question);
        
        JRadioButton r1=new JRadioButton("G"); 
    	...
    	JRadioButton r3=new JRadioButton("Q");
    	...
    	JRadioButton r4=new JRadioButton("E");
      ...
      myLabel.add(btn);
        ...
        ImageIcon QuesImg = new ImageIcon("images/Lettera.png"); // for the question images
