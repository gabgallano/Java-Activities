...
public class Quiz3{
	...
	public Quiz3() {
        ...
        JLabel Speak = new JLabel("Up for the Third!"); // for the message bubble content
    	...
    	JRadioButton r3=new JRadioButton("R");
    	...
    	JRadioButton r4=new JRadioButton("Z");
      ...
      btn.addActionListener(new ActionListener() { // an action listener to when this choice is selected
          public void actionPerformed(ActionEvent e) {
        	  ...
        	  Quiz4 p2=new Quiz4(); // directory of where it would go after clicking the button "nexT"
        	  }});
      ...
      myLabel.add(btn);
        ...
        ImageIcon QuesImg = new ImageIcon("images/Butterfly1.png"); // for the question images
