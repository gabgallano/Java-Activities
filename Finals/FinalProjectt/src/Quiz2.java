...
public class Quiz2{
	...
	public Quiz2() {
        ...
        JLabel Speak = new JLabel("2nd Question, Yay!"); // for the message bubble content
        Speak.setBounds (85,340, 150,50);
        Speak.setFont(new Font("Comic Sans MS", Font.BOLD, 15));
        myLabel.add(Speak);
        
        JLabel Question = new JLabel("The Lower Case of this letter is____"); //for the question texts
        Question.setFont(new Font("Comic Sans MS", Font.BOLD, 15));
        Question.setBounds(80, 50, 290,120);
        myLabel.add(Question);
        
        JRadioButton r1=new JRadioButton("q"); 
    	...
    	JRadioButton r2=new JRadioButton("d");
    	...
    	JRadioButton r3=new JRadioButton("p");
    	...
    	JRadioButton r4=new JRadioButton("g");
      ...
      btn.addActionListener(new ActionListener() { // an action listener to when this choice is selected
          public void actionPerformed(ActionEvent e) {
        	  ...
        	  Quiz3 p2=new Quiz3(); // directory of where it would go after clicking the button "nexT"
        	  }});
      ...
      myLabel.add(btn);
        ...
        ImageIcon QuesImg = new ImageIcon("images/LetterG.png"); // for the question images
